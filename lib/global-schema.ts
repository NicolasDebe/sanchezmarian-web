...
export const GLOBAL_SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { field: "email", type: "text", label: "Email de contacto", fallback: SITE_EMAIL, maxChars: 80 },
      { field: "phone", type: "text", label: "Teléfono", fallback: "+54 261 543-3882", maxChars: 30 },
      { field: "location_tag", type: "text", label: "Ubicación / cobertura", fallback: "Mendoza, Argentina · Trabajo remoto en LATAM", maxChars: 80 },
      { field: "cta_text", type: "text", label: "Texto del botón CTA", fallback: "Conversemos", maxChars: 30 },
