...
export const GLOBAL_SECTIONS: SectionDef[] = [
  {
    ...
    fields: [
      { field: "link_servicios", type: "text", label: "Link — Servicios", fallback: "Servicios", maxChars: 40 },
      { field: "link_valores", type: "text", label: "Link — Mis valores", fallback: "Mis valores", maxChars: 40 },
      { field: "link_casos", type: "text", label: "Link — Casos de éxito", fallback: "Casos de éxito", maxChars: 40 },
      { field: "link_campanas", type: "text", label: "Link — Campañas", fallback: "Campañas", maxChars: 40 },
    ],
  },
  {
    section: "metadata",
  ...
  },
  {
    ...
    fields: [
      { field: "tagline", type: "text", label: "Frase bajo el logo", fallback: SITE_TAGLINE, maxChars: 120 },
      { field: "email", type: "text", label: "Email de contacto", fallback: SITE_EMAIL, maxChars: 300 },
      { field: "phone", type: "text", label: "Teléfono", fallback: "+54 261 543-3882", maxChars: 40 },
      { field: "location_tag", type: "text", label: "Ubicación / cobertura", fallback: "Mendoza, Argentina · Trabajo remoto en LATAM", maxChars: 80 },
      { field: "cta_text", type: "text", label: "Texto del botón CTA", fallback: "Conversemos", maxChars: 40 },
      ...
      { field: "signature", type: "text", label: "Firma final", fallback: "Diseñado con intención.", maxChars: 80 },
    ],
  },
]
