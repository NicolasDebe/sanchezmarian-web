...
export const HOME_SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    fields: [
      { field: "eyebrow", type: "text", label: "Eyebrow (sobre las cards)", fallback: "Conversemos", maxChars: 30, resizable: true },
  ...
  },
  {
    ...
    fields: [
      { field: "stat_1_number", type: "number", label: "Estadística 1 — Número", fallback: "100+", maxChars: 8, help: "Ej: 100+, 10+, 3. Muy corto.", resizable: true },
      { field: "stat_1_label", type: "text", label: "Estadística 1 — Label", fallback: "coberturas en medios", maxChars: 36, help: "Una línea bajo el número.", resizable: true },
      { field: "stat_2_number", type: "number", label: "Estadística 2 — Número", fallback: "10+", maxChars: 8, help: "Ej: 100+, 10+, 3. Muy corto.", resizable: true },
      { field: "stat_2_label", type: "text", label: "Estadística 2 — Label", fallback: "marcas", maxChars: 36, help: "Una línea bajo el número.", resizable: true },
      { field: "stat_3_number", type: "number", label: "Estadística 3 — Número", fallback: "10+", maxChars: 8, help: "Ej: 100+, 10+, 3. Muy corto.", resizable: true },
      { field: "stat_3_label", type: "text", label: "Estadística 3 — Label", fallback: "años de experiencia", maxChars: 36, help: "Una línea bajo el número.", resizable: true },
      { field: "stat_4_number", type: "number", label: "Estadística 4 — Número", fallback: "3", maxChars: 8, help: "Ej: 100+, 10+, 3. Muy corto.", resizable: true },
      { field: "stat_4_label", type: "text", label: "Estadística 4 — Label", fallback: "servicios especializados", maxChars: 36, help: "Una línea bajo el número.", resizable: true },
    ],
  },
  {
    section: "metodo",
    ...
    fields: [
      { field: "eyebrow", type: "text", label: "Eyebrow", fallback: "Mi método de trabajo", maxChars: 40, resizable: true },
      {
        field: "title_pre",
        type: "text",
        label: "Título — parte normal",
        fallback: "Saber qué decir,",
        maxChars: 60,
      ...
      { field: "step_1_title", type: "text", label: "Paso 1 — Título", fallback: "Definición del relato", maxChars: 50, resizable: true },
      { field: "step_1_desc", type: "text", label: "Paso 1 — Descripción", fallback: "Qué historia contar y a quién.", maxChars: 160, resizable: true },
      { field: "step_2_title", type: "text", label: "Paso 2 — Título", fallback: "Diseño y mentoreo de la estrategia", maxChars: 50, resizable: true },
      { field: "step_2_desc", type: "text", label: "Paso 2 — Descripción", fallback: "Plan de comunicación personalizado.", maxChars: 160, resizable: true },
      { field: "step_3_title", type: "text", label: "Paso 3 — Título", fallback: "Gestión y relacionamiento", maxChars: 50, resizable: true },
      { field: "step_3_desc", type: "text", label: "Paso 3 — Descripción", fallback: "Junto a mi equipo ejecuto el plan de comunicación que diseñamos juntos.", maxChars: 160, resizable: true },
      { field: "step_4_title", type: "text", label: "Paso 4 — Título", fallback: "Monitoreo", maxChars: 50, resizable: true },
      { field: "step_4_desc", type: "text", label: "Paso 4 — Descripción", fallback: "Superviso cada interacción de la campaña.", maxChars: 160, resizable: true },
      { field: "step_5_title", type: "text", label: "Paso 5 — Título", fallback: "Análisis de impacto", maxChars: 50, resizable: true },
      { field: "step_5_desc", type: "text", label: "Paso 5 — Descripción", fallback: "Resultados medibles y claros para avanzar al próximo nivel.", maxChars: 160, resizable: true },
    ],
  },
  {
    section: "bio",
  ...
  },
  {
    ...
    fields: [
      { field: "eyebrow", type: "text", label: "Eyebrow", fallback: "Hagamos que las cosas pasen.", maxChars: 80, resizable: true },
      {
        field: "title_pre",
        type: "text",
        label: "Título — parte normal",
