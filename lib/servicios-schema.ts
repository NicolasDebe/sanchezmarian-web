...
export const SERVICIOS_SECTIONS: SectionDef[] = [
  ...
  /* ───────────── PILARES ───────────── */
  {
    ...
    fields: [
      ...
      { field: "pilar_2_items", type: "longtext", plain: true, label: "Pilar 02 — Ítems (uno por línea)", fallback: "Se seleccionan los canales según la estrategia y el público objetivo.\nPueden incluir medios tradicionales, redes sociales, eventos presenciales, producciones audiovisuales, activaciones de marca, medios digitales, entre otros.\nNo existe una fórmula única: cada empresa requiere su propio mix de comunicación.", maxChars: 700 },
      { field: "pilar_3_title", type: "text", label: "Pilar 03 — Título", fallback: "Objetivos comerciales", maxChars: 60 },
      { field: "pilar_3_items", type: "longtext", plain: true, label: "Pilar 03 — Ítems (uno por línea)", fallback: "Cada acción de comunicación responde a un objetivo de negocio concreto.\nSe busca visibilidad, posicionamiento, reputación y resultados medibles.\nLa estrategia se evalúa y ajusta de forma periódica según los resultados obtenidos.", maxChars: 600 },
      { field: "intro_note", type: "longtext", plain: true, label: "Nota introductoria al catálogo", fallback: "Los siguientes servicios están contenidos dentro de la Estrategia en Comunicación y pueden ofrecerse como parte del paquete integral o de manera individual según las necesidades de cada cliente.", maxChars: 400 },
    ],
  },
  ...
  /* ───────────── BLOQUE 01 — Estrategia y Consultoría General ───────────── */
  {
    ...
    fields: [
      ...
      { field: "sub_1_desc", type: "longtext", plain: true, label: "Punto 1 — Descripción", fallback: "Se diseña o adapta la estrategia macro y se coordina cada una de sus aristas para que todas las acciones tanto internas como externas y contenidos formen parte de un mismo mecanismo integrado.", maxChars: 400 },
      { field: "sub_2_title", type: "text", label: "Punto 2 — Título", fallback: "Cero micromanagement", maxChars: 80 },
      { field: "sub_2_desc", type: "longtext", plain: true, label: "Punto 2 — Descripción", fallback: "Se elimina por completo la carga operativa del referente de la empresa. El servicio asume la supervisión técnica directa de las redacciones, piezas visuales y campañas, evitando la necesidad de que el cliente tenga que validar o aprobar cada detalle diario.", maxChars: 400 },
      { field: "sub_3_title", type: "text", label: "Punto 3 — Título", fallback: "Asistencia y consultoría", maxChars: 80 },
      { field: "sub_3_desc", type: "longtext", plain: true, label: "Punto 3 — Descripción", fallback: "Funciona como un espacio de asesoría continua sobre cómo trabajar estratégicamente la comunicación en cada plataforma. Incluye un acompañamiento permanente y técnico a los profesionales de redes sociales, marketing, diseño, programación y productores audiovisuales, asegurando que ejecuten bajo un mismo criterio.", maxChars: 500 },
      { field: "sub_4_title", type: "text", label: "Punto 4 — Título", fallback: "Garantía de coherencia", maxChars: 80 },
      { field: "sub_4_desc", type: "longtext", plain: true, label: "Punto 4 — Descripción", fallback: "Se asegura que el propósito del negocio se traduzca de forma idéntica, orgánica y fluida en cada canal, logrando que toda la comunicación funcione.", maxChars: 400 },
    ],
  },
  ...
  /* ───────────── BLOQUE 03 — Relaciones Públicas y Eventos ───────────── */
  {
    ...
    fields: [
      ...
      { field: "closing", type: "longtext", plain: true, label: "Párrafo de cierre", fallback: "El foco está en que cada evento tenga un impulso estratégico real, y no sea simplemente una acción aislada sin retorno medible.", maxChars: 300 },
  ...
  /* ───────────── BLOQUE 04 — Oratoria y Asesoría de Imagen ───────────── */
  {
    ...
    fields: [
      ...
      { field: "imagen_label", type: "text", label: "Sub-bloque B — Label", fallback: "La asesoría de imagen contempla", maxChars: 50 },
