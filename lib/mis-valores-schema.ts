...
export const MIS_VALORES_SECTIONS: SectionDef[] = [
  {
    ...
    fields: [
      ...
      { field: "h1_pre", type: "text", label: "Título — primera línea", fallback: "Detrás de la estrategia:", maxChars: 80 },
  ...
  },
  {
    ...
    fields: [
      ...
      { field: "title_pre", type: "text", label: "Título — parte normal", fallback: "Los pilares que", maxChars: 60 },
      { field: "title_accent", type: "text", label: "Título — texto destacado (cursiva bordó)", fallback: "guían mi trabajo.", maxChars: 60 },
      { field: "intro", type: "longtext", label: "Texto introductorio", fallback: "Esta trayectoria es la que hoy me permite dar vida a mis valores en cada consultoría:", maxChars: 300 },
      { field: "pilar_1_title", type: "text", label: "Pilar 1 — Título", fallback: "Inteligencia y Oficio", maxChars: 60 },
      { field: "pilar_1_desc", type: "longtext", label: "Pilar 1 — Descripción", fallback: "Combino el respaldo de mis años de estudio con la experiencia real del terreno y una capacitación constante para tomar decisiones estratégicas y con criterio.", maxChars: 400 },
      { field: "pilar_2_title", type: "text", label: "Pilar 2 — Título", fallback: "Integridad", maxChars: 60 },
      { field: "pilar_2_desc", type: "longtext", label: "Pilar 2 — Descripción", fallback: "Construyo puentes honestos y transparentes. Prefiero cuidar la confianza a largo plazo con un periodista que forzar una noticia sin valor real.", maxChars: 400 },
      { field: "pilar_3_title", type: "text", label: "Pilar 3 — Título", fallback: "Libertad", maxChars: 60 },
      { field: "pilar_3_desc", type: "longtext", label: "Pilar 3 — Descripción", fallback: "Mi negocio y trabajo está basado en objetivos, no en horarios rígidos. Esa misma independencia me da la libertad de palabra para asesorarte con total franqueza y decirte siempre lo que tu marca necesita escuchar.", maxChars: 400 },
      { field: "pilar_4_title", type: "text", label: "Pilar 4 — Título", fallback: "Responsabilidad y Compromiso", maxChars: 60 },
      { field: "pilar_4_desc", type: "longtext", label: "Pilar 4 — Descripción", fallback: "No soy una proveedora externa más; me involucro en tu negocio como una aliada estratégica para cuidar cada detalle.", maxChars: 400 },
      { field: "pilar_5_title", type: "text", label: "Pilar 5 — Título", fallback: "Pasión", maxChars: 60 },
      { field: "pilar_5_desc", type: "longtext", label: "Pilar 5 — Descripción", fallback: "Amo profundamente lo que hago. Disfruto el ecosistema multiplataforma y me entusiasma transformar el propósito de las personas y empresas en historias que merecen ser contadas.", maxChars: 400 },
    ],
  },
  {
    section: "cierre",
