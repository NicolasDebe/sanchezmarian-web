        ...
        <div className="relative mx-auto grid items-center gap-x-16 gap-y-12 lg:grid-cols-[1.15fr_0.85fr]" style={{ maxWidth: 1180 }}>
          ...
          <div>
            ...
            <SplitWords
              ...
              style={{ fontSize: "clamp(40px, 6vw, 92px)", lineHeight: 1.03, letterSpacing: "-0.035em" }}
            />
            ...
            {s.descripcion && (
              <motion.div
                ...
                style={{ fontSize: "clamp(17px, 1.4vw, 20px)", lineHeight: 1.65, maxWidth: 620 }}
              >
          ...
          {s.tagline && (
            <div className="relative lg:pl-6">
              <span
                ...
                style={{ fontSize: "clamp(60px, 8vw, 100px)", lineHeight: 0.6, height: "0.55em" }}
              >
                &ldquo;
              </span>
              <motion.p
                ...
                style={{ fontSize: "clamp(28px, 3vw, 44px)", lineHeight: 1.22, letterSpacing: "-0.01em" }}
              >
                {s.tagline}
              </motion.p>
                    ...
                    >
                      <div className={full ? "" : "grid items-start gap-x-10 gap-y-2 md:grid-cols-2"}>
                        <div className="flex items-baseline gap-4">
                          <span className="font-mono text-bordo" style={{ fontSize: full ? 15 : 13 }}>{two(i + 1)}</span>
                          <h3 className="relative inline-block w-fit">
                            <span
                              className="font-playfair font-bold text-negro-bordo"
                              style={{
                                fontSize: full ? "clamp(26px, 3.2vw, 40px)" : "clamp(20px, 2.4vw, 30px)",
                                lineHeight: 1.15,
