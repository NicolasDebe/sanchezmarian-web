    ...
    <main className="min-h-dvh bg-arena flex items-center justify-center px-6">
      <div className="flex flex-col items-center text-center gap-8 max-w-md">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="font-sans text-gris-bordo text-[length:var(--fs-body-lg)] leading-[1.7]">
            Te contacto pronto.
          </p>
        </div>
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 bg-bordo text-hueso px-8 py-3.5 rounded-full font-sans text-[length:var(--fs-caption)] font-semibold hover:bg-bordo/90 active:scale-[0.98] transition-all"
        >
          Volver al inicio
