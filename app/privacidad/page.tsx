...
const SECTIONS = [
  ...
  {
    title: "Tus derechos",
    body: "Tenés derecho a acceder, corregir o solicitar la eliminación de tus datos personales. Para ejercer estos derechos, escribinos a sanchezmariana15@gmail.com.",
  },
  {
    title: "Contacto",
    body: "Ante cualquier consulta sobre esta política de privacidad, podés contactarnos en sanchezmariana15@gmail.com.",
  },
]
    ...
    <main>
      ...
      <section className="bg-arena pt-32 pb-16">
        <div className="max-w-[800px] mx-auto px-6 lg:px-8">
          ...
          <h1 className="font-playfair font-bold text-marino text-[2.25rem] sm:text-[2.75rem] leading-[1.1]">
            Política de Privacidad
          </h1>
          <p className="font-mono text-[10px] text-gris-tx/50 mt-4">
        ...
        <div className="max-w-[800px] mx-auto px-6 lg:px-8 flex flex-col gap-10">
          {SECTIONS.map((s) => (
            <div key={s.title} className="flex flex-col gap-3">
              <h2 className="font-playfair font-bold text-marino text-xl">{s.title}</h2>
              <p className="font-sans text-[16px] text-gris-tx leading-[1.7]">{s.body}</p>
            </div>
          ))}
          ...
          <div className="pt-4 border-t border-marino/10">
            <Link
              href="/"
              className="font-sans text-sm font-medium text-terracota hover:text-marino transition-colors"
            >
              ← Volver al inicio
            </Link>
          </div>
