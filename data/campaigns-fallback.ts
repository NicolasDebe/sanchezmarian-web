...
/**
 * Fallback hardcoded de /campanas: si Supabase falla por cualquier razón,
 * la página pública se ve idéntica con estas 3 campañas (las del seed).
 * Misma filosofía que data/clippings.ts.
 */
...
`.trim(),
    images: [
      { id: "f1-1", campaign_id: "fallback-1", url: "/images/1.jpg", alt: "Lynk & Co Mendoza", position: 1 },
      { id: "f1-2", campaign_id: "fallback-1", url: "/images/2.jpg", alt: "Lynk & Co Mendoza", position: 2 },
      { id: "f1-3", campaign_id: "fallback-1", url: "/images/3.jpg", alt: "Lynk & Co Mendoza", position: 3 },
      { id: "f1-4", campaign_id: "fallback-1", url: "/images/4.jpg", alt: "Lynk & Co Mendoza", position: 4 },
      { id: "f1-5", campaign_id: "fallback-1", url: "/images/5.jpg", alt: "Lynk & Co Mendoza", position: 5 },
    ],
  },
  {
    id: "fallback-2",
...
`.trim(),
    images: [
      { id: "f2-1", campaign_id: "fallback-2", url: "/images/NAC_3874.jpg", alt: "BCM Comisión del Precio del Vino", position: 1 },
      { id: "f2-2", campaign_id: "fallback-2", url: "/images/NAC_3895.jpg", alt: "BCM Comisión del Precio del Vino", position: 2 },
      { id: "f2-3", campaign_id: "fallback-2", url: "/images/NAC_4000.jpg", alt: "BCM Comisión del Precio del Vino", position: 3 },
      { id: "f2-4", campaign_id: "fallback-2", url: "/images/NAC_4067.jpg", alt: "BCM Comisión del Precio del Vino", position: 4 },
    ],
  },
  {
    id: "fallback-3",
...
`.trim(),
    images: [
      { id: "f3-1", campaign_id: "fallback-3", url: "/images/1.jpeg", alt: "Capilla Carlo Acutis Luján de Cuyo", position: 1 },
      { id: "f3-2", campaign_id: "fallback-3", url: "/images/2.jpeg", alt: "Capilla Carlo Acutis Luján de Cuyo", position: 2 },
      { id: "f3-3", campaign_id: "fallback-3", url: "/images/3.jpeg", alt: "Capilla Carlo Acutis Luján de Cuyo", position: 3 },
      { id: "f3-4", campaign_id: "fallback-3", url: "/images/4.jpeg", alt: "Capilla Carlo Acutis Luján de Cuyo", position: 4 },
      { id: "f3-5", campaign_id: "fallback-3", url: "/images/5.jpeg", alt: "Capilla Carlo Acutis Luján de Cuyo", position: 5 },
      { id: "f3-6", campaign_id: "fallback-3", url: "/images/6.jpeg", alt: "Capilla Carlo Acutis Luján de Cuyo", position: 6 },
      { id: "f3-7", campaign_id: "fallback-3", url: "/images/7.jpeg", alt: "Capilla Carlo Acutis Luján de Cuyo", position: 7 },
      { id: "f3-8", campaign_id: "fallback-3", url: "/images/8.jpeg", alt: "Capilla Carlo Acutis Luján de Cuyo", position: 8 },
      { id: "f3-9", campaign_id: "fallback-3", url: "/images/9.jpeg", alt: "Capilla Carlo Acutis Luján de Cuyo", position: 9 },
    ],
  },
]
